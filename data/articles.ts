export const articles = [
...

  {
    ...
    content: [
      ...
      "",
      "<img src='/berita/marketshare-mobil-mei-2026.png' alt='Market Share Brand Mobil Terlaris Mei 2026' class='w-full h-auto border border-gray-200 shadow-md my-8 hover:shadow-xl transition-shadow duration-300' />",
