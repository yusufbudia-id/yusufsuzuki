...
- DP Bayar (Nett): ${formatCurrency(dpBayar)}
- Diskon Promo: ${formatCurrency(diskon)}
              ...
              {[12, 24, 36, 48, 60].map((t) => (
                <button
                  ...
                  className={`py-3 text-xs font-black transition-all border ${
                    tenor === t ? "bg-gray-900 border-gray-900 text-white" : "border-gray-200 bg-white text-gray-400 hover:border-gray-900 hover:text-gray-900"
                  }`}
                >
                  {t/12} THN
                </button>
                  ...
                  <form onSubmit={handlePinSubmit} className="flex flex-col gap-2 w-full">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        autoFocus
                      />
                      <button type="submit" className="bg-gray-900 text-white px-4 text-[10px] font-bold rounded-sm hover:bg-black">
                        OK
                      </button>
                    </div>
