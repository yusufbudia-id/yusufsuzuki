...
export default function WhatsappFloatingButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-50 hidden items-center gap-3 border border-whatsapp/30 bg-[#050505] px-4 py-3 text-white shadow-dark-glow transition-all hover:-translate-y-0.5 hover:border-whatsapp hover:bg-whatsapp md:flex"
