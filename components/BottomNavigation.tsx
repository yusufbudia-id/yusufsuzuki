          ...
          if (item.isSpecial) {
            return (
              <div key={item.id} className="relative flex w-1/5 flex-col items-center justify-start">
                <a href={buildWhatsAppUrl(leadContext.message)} target="_blank" rel="noopener noreferrer" aria-label="Chat WhatsApp Yusuf Suzuki" className="group flex w-full flex-col items-center">
                  ...
                  <span className="text-[9px] font-black uppercase tracking-[0.16em] text-whatsapp">{leadContext.mobileLabel}</span>
                </a>
              </div>
            );
          }
