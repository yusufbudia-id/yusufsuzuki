          ...
          if (item.isSpecial) {
            return (
              <div key={item.id} className="flex flex-col items-center justify-start w-1/5 relative">
                ...
                >
                  {/* Lingkaran WhatsApp Melayang (Tanpa Border Putih) */}
                  <div className="relative flex items-center justify-center w-12 h-12 bg-[#25D366] text-white rounded-full shadow-[0_4px_12px_rgba(37,211,102,0.4)] group-active:scale-95 transition-transform -mt-7 mb-1">
